...
var readVisibility = new Simple_JSON.ReadForeign(Foreign_Generic_EnumEncoding.genericDecodeEnum(genericVisibility)(Foreign_Generic_EnumEncoding.sumGenericDecodeEnum(Foreign_Generic_EnumEncoding.ctorNoArgsGenericDecodeEnum(new Data_Symbol.IsSymbol(function ($dollar__unused) {
    return "All";
})))(Foreign_Generic_EnumEncoding.sumGenericDecodeEnum(Foreign_Generic_EnumEncoding.ctorNoArgsGenericDecodeEnum(new Data_Symbol.IsSymbol(function ($dollar__unused) {
    return "Completed";
})))(Foreign_Generic_EnumEncoding.ctorNoArgsGenericDecodeEnum(new Data_Symbol.IsSymbol(function ($dollar__unused) {
    return "Active";
})))))({
    constructorTagTransform: Data_String_Common.toLower
}));
var showVisibility = new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericVisibility)(Data_Generic_Rep_Show.genericShowSum(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsNoArguments)(new Data_Symbol.IsSymbol(function ($dollar__unused) {
    return "All";
})))(Data_Generic_Rep_Show.genericShowSum(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsNoArguments)(new Data_Symbol.IsSymbol(function ($dollar__unused) {
    return "Completed";
})))(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsNoArguments)(new Data_Symbol.IsSymbol(function ($dollar__unused) {
    return "Active";
}))))));
var writeVisibility = new Simple_JSON.WriteForeign(Foreign_Generic_EnumEncoding.genericEncodeEnum(genericVisibility)(Foreign_Generic_EnumEncoding.sumGenericEncodeEnum(Foreign_Generic_EnumEncoding.ctorNoArgsGenericEncodeEnum(new Data_Symbol.IsSymbol(function ($dollar__unused) {
    return "All";
})))(Foreign_Generic_EnumEncoding.sumGenericEncodeEnum(Foreign_Generic_EnumEncoding.ctorNoArgsGenericEncodeEnum(new Data_Symbol.IsSymbol(function ($dollar__unused) {
    return "Completed";
})))(Foreign_Generic_EnumEncoding.ctorNoArgsGenericEncodeEnum(new Data_Symbol.IsSymbol(function ($dollar__unused) {
    return "Active";
})))))({
    constructorTagTransform: Data_String_Common.toLower
}));
    ...
    return function (visibility) {
        return function (actualVisibility) {
            return React_Basic_DOM_Generated.li_([ React_Basic_DOM_Generated.a()({
                className: (function () {
                    var $256 = Data_Eq.eq(eqVisibility)(visibility)(actualVisibility);
                    if ($256) {
                        return "selected";
                    };
                    return "";
