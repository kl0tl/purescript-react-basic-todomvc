...
import * as Data_Generic_Rep_Bounded from "../Data.Generic.Rep.Bounded/index.js";
                ...
                return new GenericEnum(function (v) {
                    ...
                    if (v instanceof Data_Generic_Rep.Inr) {
                        ...
                        if (v1 instanceof Data_Maybe.Nothing) {
                            return new Data_Maybe.Just(new Data_Generic_Rep.Inl(Data_Generic_Rep_Bounded["genericTop$prime"](dictGenericTop)));
                        };
                    ...
                    if (v instanceof Data_Generic_Rep.Inl) {
                        ...
                        if (v1 instanceof Data_Maybe.Nothing) {
                            return new Data_Maybe.Just(new Data_Generic_Rep.Inr(Data_Generic_Rep_Bounded["genericBottom$prime"](dictGenericBottom)));
                        };
                        if (v1 instanceof Data_Maybe.Just) {
                ...
                return function (dictGenericTop1) {
                    return function (dictGenericBottom1) {
                        return new GenericEnum(function (v) {
                            ...
                            if (v1 instanceof Data_Maybe.Nothing) {
                                return Data_Functor.map(Data_Maybe.functorMaybe)(Data_Function.flip(Data_Generic_Rep.Product.create)(Data_Generic_Rep_Bounded["genericTop$prime"](dictGenericTop1)))(genericPred$prime(dictGenericEnum)(v.value0));
                            };
                            ...
                            if (v1 instanceof Data_Maybe.Nothing) {
                                return Data_Functor.map(Data_Maybe.functorMaybe)(Data_Function.flip(Data_Generic_Rep.Product.create)(Data_Generic_Rep_Bounded["genericBottom$prime"](dictGenericBottom1)))(genericSucc$prime(dictGenericEnum)(v.value0));
                            };
